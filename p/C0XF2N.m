...
PROCESS(ZRTN,ZRDF,ZGRF,ZMETA,FARY)	; PROCESS AN INCOMING RDF FILE
	...
	. W !,"Not an XML file"
	N ZZI S ZZI=""
	F  S ZZI=$O(@ZRDF@(ZZI)) Q:ZZI=""  D  ;
	. N ZZX S ZZX=@ZRDF@(ZZI)
	. I ZZX["Name >" S ZZX=$P(ZZX,"Name >",1)_"Name>"_$P(ZZX,"Name >",2)
	. I ZZX["Device >" S ZZX=$P(ZZX,"Device >",1)_"Device>"_$P(ZZX,"Device >",2)
	. S @ZRDF@(ZZI)=ZZX
